...
/**
 * Refresh token - A class for creating jwt token credential as a refresh request.
 *
 ...
 */
class JwtRefreshTokenCredentialFactory extends JwtCredentialFactory
{
	/**
	...
	{
		return CredentialTypes::REFRESH_TOKEN;
	}
}